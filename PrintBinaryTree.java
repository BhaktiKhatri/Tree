...
Explanation and Code from: @GardenAAA https://leetcode.com/problems/print-binary-tree/discuss/106239/Java-Recursive-Solution
 */
...
public class PrintBinaryTree {
	...
	public static void populateResult(TreeNode root, List<List<String>> result, int curRow, int totalRow, int i, int j) {
	...
	public static void main(String[] args) {
		...
		System.out.println(printTree(tree.root));
